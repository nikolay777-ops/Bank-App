...
def account_view(request, currency):
    ...
    if user_name and secret_key:
        account = CurrencyAccount.objects.get(user__name=user_name, owner__phone_number=phone_num, currency__name=currency)
...
def accounts_view(request):
    ...
    phone_num = cache.get('phone_num')
    if user_name and secret_key:
        accounts = CurrencyAccount.objects.filter(user__name=user_name, user__phone_number=phone_num)
