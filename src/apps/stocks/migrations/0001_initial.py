...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Stock',
            fields=[
                ('name', models.CharField(choices=[('A', 'A'), ('A', 'A'), ('P', 'P'), ('L', 'L')], primary_key=True, serialize=False)),
            ],
            options={
                'verbose_name': 'Stock',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_price', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='stocks.stockprices')),
            ],
            options={
